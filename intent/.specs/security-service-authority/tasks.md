...
- [ ] T0. Module prerequisites and additive foundation
  - [ ] T0.1 [module] (satisfies: R1) — Install `Intent.ModuleBuilder`
  ...
  - [ ] T0.6 [model] (satisfies: R1, R2, R16) — Add additive registration and capability-validation factory extensions
  ...
  - [ ] T0.7 [code] (satisfies: R1.1, R1.2, R1.3, R1.5, R1.6) — Implement additive capability lookup, feature gating, and conflict diagnostics
  ...
  - [ ] T0.8 [code] (satisfies: R1.4) — Write additive-installation and generation-idempotency tests
...
- [ ] T1. Core host contracts, persistence, records, and validation
  - [ ] T1.1 [model] (satisfies: R2, R15, R16) — Add authority host contracts and persistence integration
  ...
  - [ ] T1.2 [model] (satisfies: R3, R16) — Add authoritative enums and record contracts
  ...
  - [ ] T1.3 [model] (satisfies: R3, R16) — Add comprehensive authority validation
  ...
  - [ ] T1.4 [code] (satisfies: R2.1, R2.3, R2.5, R2.6, R16.1, R16.2) — Implement host persistence and atomic-operation behavior
  ...
  - [ ] T1.5 [code] (satisfies: R2.2, R2.4, R3, R16.3, R16.7) — Implement record invariants and Tenant Adapter validation
  ...
  - [ ] T1.6 [code] (satisfies: R2, R3, R16.1, R16.2, R16.3, R16.7) — Write core contract, persistence, record, and validation tests
...
- [ ] T2. Cryptography, discovery, and OAuth Client validation
  - [ ] T2.1 [model] (satisfies: R4, R7) — Add cryptography options and implementation template
  ...
  - [ ] T2.2 [model] (satisfies: R3, R5, R9) — Add discovery endpoints and OAuth Client validation model
  ...
  - [ ] T2.3 [code] (satisfies: R4.1, R4.2, R4.3, R4.4, R4.5, R4.6, R4.7, R4.8) — Implement cryptographic material and secret safety
  ...
  - [ ] T2.4 [code] (satisfies: R5.1, R5.2, R5.3, R5.4, R5.5, R5.6, R5.7) — Implement discovery, JWKS, and OAuth Client validation
  ...
  - [ ] T2.5 [code] (satisfies: R4, R5) — Write cryptography, discovery, and client-validation tests
...
- [ ] T3. SSO sessions and external identity provider brokering
  - [ ] T3.1 [model] (satisfies: R9) — Add SSO Session, UserInfo, and logout endpoint model
  ...
  - [ ] T3.2 [model] (satisfies: R10) — Add external provider brokering model
  ...
  - [ ] T3.3 [code] (satisfies: R9.1, R9.2, R9.3, R9.4, R9.5, R9.6, R9.7) — Implement SSO Session, UserInfo, and logout behavior
  ...
  - [ ] T3.4 [code] (satisfies: R10.1, R10.2, R10.3, R10.4, R10.5, R10.6, R10.7) — Implement external provider selection and callback processing
  ...
  - [ ] T3.5 [code] (satisfies: R9, R10) — Write session and external-provider tests
...
- [ ] T4. Authorization Code, token, and Device Authorization protocols
  - [ ] T4.1 [model] (satisfies: R6) — Add Authorization Code and callback endpoint model
  ...
  - [ ] T4.2 [model] (satisfies: R7) — Add token endpoint and token metadata model
  ...
  - [ ] T4.3 [model] (satisfies: R8) — Add Device Authorization endpoint model
  ...
  - [ ] T4.4 [code] (satisfies: R6.1, R6.2, R6.3, R6.4, R6.5, R6.7, R6.8) — Implement authorization request and callback flow
  ...
  - [ ] T4.5 [code] (satisfies: R6.6, R7.1, R7.2, R7.3, R7.4, R7.5, R7.6, R7.10) — Implement token dispatch, claims, and protocol errors
  ...
  - [ ] T4.6 [code] (satisfies: R7.7, R7.8, R7.9) — Implement Refresh Token rotation and replay response
  ...
  - [ ] T4.7 [code] (satisfies: R8.1, R8.2, R8.3, R8.4, R8.5, R8.6, R8.7, R8.8) — Implement Device Authorization lifecycle
  ...
  - [ ] T4.8 [code] (satisfies: R6, R7.1, R7.2, R7.4, R7.5, R7.6, R7.9, R7.10) — Write Authorization Code and token endpoint tests
  ...
  - [ ] T4.9 [code] (satisfies: R7.7, R7.8, R8) — Write Refresh Token and Device Authorization tests
...
- [ ] T5. Tenant-aware Roles, Grants, and authorization
  - [ ] T5.1 [model] (satisfies: R13) — Add authorization administration and engine model
  ...
  - [ ] T5.2 [code] (satisfies: R13.1, R13.2, R13.3, R13.4, R13.5, R13.6, R13.7, R13.8, R13.9) — Implement resource-aware authorization evaluation
  ...
  - [ ] T5.3 [code] (satisfies: R2.2, R2.4, R13) — Write Tenant Resource, Role, Grant, and authorization tests
...
- [ ] T6. Bootstrap, lifecycle, Services, API Keys, and management APIs
  - [ ] T6.1 [model] (satisfies: R11) — Add bootstrap and User lifecycle model
  ...
  - [ ] T6.2 [model] (satisfies: R12) — Add Service and API Key lifecycle model
  ...
  - [ ] T6.3 [model] (satisfies: R14) — Add the versioned management API contract
  ...
  - [ ] T6.4 [code] (satisfies: R11.1, R11.2, R11.3, R11.4, R11.5) — Implement administrator bootstrap strategies
  ...
  - [ ] T6.5 [code] (satisfies: R11.6, R11.7, R11.8) — Implement User and Service lifecycle cascades
  ...
  - [ ] T6.6 [code] (satisfies: R12.1, R12.2, R12.3) — Implement Service administration and idempotent provisioning
  ...
  - [ ] T6.7 [code] (satisfies: R12.4, R12.5, R12.6, R12.7, R12.8, R12.9) — Implement API Key issue, regeneration, and authentication
  ...
  - [ ] T6.8 [code] (satisfies: R14.1, R14.2, R14.4, R14.5, R14.8, R14.9) — Implement management resources, authorization, and response contracts
  ...
  - [ ] T6.9 [code] (satisfies: R14.3, R14.6, R14.7) — Implement management paging, idempotency, and concurrency
  ...
  - [ ] T6.10 [code] (satisfies: R11, R12) — Write bootstrap, lifecycle, Service, and API Key tests
  ...
  - [ ] T6.11 [code] (satisfies: R14) — Write management API contract tests
...
- [ ] T7. Integration events, post-commit delivery, cleanup, and conformance
  - [ ] T7.1 [model] (satisfies: R15) — Add Integration Event and post-commit adapter model
  ...
  - [ ] T7.2 [model] (satisfies: R16) — Add cleanup and conformance templates
  ...
  - [ ] T7.3 [code] (satisfies: R15.1, R15.2, R15.3, R15.4) — Implement Integration Event validation and at-most-once mutation
  ...
  - [ ] T7.4 [code] (satisfies: R15.5, R15.6, R15.7, R15.8) — Implement post-commit notifications, auditing, and delivery failure handling
  ...
  - [ ] T7.5 [code] (satisfies: R16.4, R16.5, R16.6) — Implement retention and race-safe cleanup
  ...
  - [ ] T7.6 [code] (satisfies: R15, R16.1, R16.2, R16.3, R16.4, R16.5, R16.6, R16.7) — Write integration, delivery, and cleanup tests
  ...
  - [ ] T7.7 [code] (satisfies: R4, R5, R6, R7, R8, R9, R10, R12, R13, R14, R15, R16.8) — Complete protocol and safety conformance test implementations
