...
namespace Aryzac.Documentation.Templates.Application.Query
{
    ...
    public class QueryTemplateRegistration : FilePerModelTemplateRegistration<QueryModel>
    {
        ...
        public override string TemplateId => QueryTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, QueryModel model)
        {
            return new QueryTemplate(outputTarget, model);
        }
