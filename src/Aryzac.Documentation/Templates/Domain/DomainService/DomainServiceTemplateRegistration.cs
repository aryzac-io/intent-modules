...
namespace Aryzac.Documentation.Templates.Domain.DomainService
{
    ...
    public class DomainServiceTemplateRegistration : FilePerModelTemplateRegistration<DomainServiceModel>
    {
        private readonly IMetadataManager _metadataManager;

        public DomainServiceTemplateRegistration(IMetadataManager metadataManager)
        {
            _metadataManager = metadataManager;
        }

        public override string TemplateId => DomainServiceTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, DomainServiceModel model)
        {
            return new DomainServiceTemplate(outputTarget, model);
        }
