...
namespace Aryzac.VueJS.Api
{
    ...
    public class ClientModel : IHasStereotypes, IMetadataModel
    {
        ...
        public const string SpecializationTypeId = "21090ba9-4427-456c-9b08-af107b145cdd";
        ...
        public IList<ComposableModel> Composables => UnderlyingPackage.ChildElements
    .GetElementsOfType(ComposableModel.SpecializationTypeId)
