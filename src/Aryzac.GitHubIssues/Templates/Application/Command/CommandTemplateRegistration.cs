...
namespace Aryzac.GitHubIssues.Templates.Application.Command
{
    ...
    public class CommandTemplateRegistration : FilePerModelTemplateRegistration<CommandModel>
    {
        ...
        public override string TemplateId => CommandTemplate.TemplateId;

        [IntentManaged(Mode.Fully)]
        public override ITemplate CreateTemplateInstance(IOutputTarget outputTarget, CommandModel model)
        {
            return new CommandTemplate(outputTarget, model);
        }
