...
namespace Aryzac.GitHubIssues.Templates.Api.HttpEndpointQuery
{
    ...
    partial class HttpEndpointQueryTemplate : IntentTemplateBase<QueryModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.GitHubIssues.Api.HttpEndpointQuery";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public HttpEndpointQueryTemplate(IOutputTarget outputTarget, QueryModel model) : base(TemplateId, outputTarget, model)
        {
        }
        ...
        public override ITemplateFileConfig GetTemplateFileConfig()
        {
            return new TemplateFileConfig(
                fileName: $"Queries/{this.GetFolderPath()}/{Model.Name}",
                fileExtension: "md"
            );
        }
