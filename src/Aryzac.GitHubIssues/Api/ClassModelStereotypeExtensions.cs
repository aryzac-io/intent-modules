...
namespace Aryzac.GitHubIssues.Api
{
    ...
    {
        public static BusinessRequirement GetBusinessRequirement(this ClassModel model)
        {
        ...
        public static bool HasBusinessRequirement(this ClassModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this ClassModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this ClassModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this ClassModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this ClassModel model, out GitHubIssueClosed stereotype)
        {
