...
namespace Aryzac.GitHubIssues.Api
{
    ...
    {
        public static BusinessRequirement GetBusinessRequirement(this CommandModel model)
        {
        ...
        public static bool HasBusinessRequirement(this CommandModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this CommandModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this CommandModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this CommandModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this CommandModel model, out GitHubIssueClosed stereotype)
        {
