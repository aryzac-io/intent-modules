...
namespace Aryzac.GitHubIssues.Api
{
    ...
    {
        public static BusinessRequirement GetBusinessRequirement(this DTOModel model)
        {
        ...
        public static bool HasBusinessRequirement(this DTOModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this DTOModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this DTOModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this DTOModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this DTOModel model, out GitHubIssueClosed stereotype)
        {
