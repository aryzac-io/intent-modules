...
namespace Aryzac.GitHubIssues.Api
{
    ...
    {
        public static BusinessRequirement GetBusinessRequirement(this ValueObjectModel model)
        {
        ...
        public static bool HasBusinessRequirement(this ValueObjectModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this ValueObjectModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this ValueObjectModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this ValueObjectModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this ValueObjectModel model, out GitHubIssueClosed stereotype)
        {
