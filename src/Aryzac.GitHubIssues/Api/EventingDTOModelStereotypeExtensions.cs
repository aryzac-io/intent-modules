...
{
    public static class EventingDTOModelStereotypeExtensions
    {
        public static BusinessRequirement GetBusinessRequirement(this EventingDTOModel model)
        {
        ...
        public static bool HasBusinessRequirement(this EventingDTOModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this EventingDTOModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this EventingDTOModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this EventingDTOModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this EventingDTOModel model, out GitHubIssueClosed stereotype)
        {
