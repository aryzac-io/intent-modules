...
namespace Aryzac.GitHubIssues.Api
{
    ...
    {
        public static BusinessRequirement GetBusinessRequirement(this MessageModel model)
        {
        ...
        public static bool HasBusinessRequirement(this MessageModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this MessageModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this MessageModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this MessageModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this MessageModel model, out GitHubIssueClosed stereotype)
        {
