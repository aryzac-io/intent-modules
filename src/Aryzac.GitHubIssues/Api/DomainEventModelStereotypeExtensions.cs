...
{
    public static class DomainEventModelStereotypeExtensions
    {
        public static BusinessRequirement GetBusinessRequirement(this DomainEventModel model)
        {
        ...
        public static bool HasBusinessRequirement(this DomainEventModel model)
        {
            return model.HasStereotype(BusinessRequirement.DefinitionId);
        }

        public static bool TryGetBusinessRequirement(this DomainEventModel model, out BusinessRequirement stereotype)
        {
        ...
        public static GitHubIssueClosed GetGitHubIssueClosed(this DomainEventModel model)
        {
        ...
        public static bool HasGitHubIssueClosed(this DomainEventModel model)
        {
            return model.HasStereotype(GitHubIssueClosed.DefinitionId);
        }

        public static bool TryGetGitHubIssueClosed(this DomainEventModel model, out GitHubIssueClosed stereotype)
        {
