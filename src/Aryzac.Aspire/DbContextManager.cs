...
public class DbContextInstance : IMetadataModel
{
    ...
    {
        return template.TryGetTypeName("Infrastructure.Data.ConnectionStringDbContext", this, out var dbContextName) ? dbContextName : (defaultDbContextName ?? string.Empty);
    }
