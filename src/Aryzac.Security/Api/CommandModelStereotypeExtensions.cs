...
namespace Aryzac.Security.Api
{
    ...
    {
        public static ScopeSettings GetScopeSettings(this CommandModel model)
        {
            var stereotype = model.GetStereotype(ScopeSettings.DefinitionId);
            return stereotype != null ? new ScopeSettings(stereotype) : null;
        }

        public static IReadOnlyCollection<ScopeSettings> GetScopeSettingss(this CommandModel model)
        {
        ...
        public static bool HasScopeSettings(this CommandModel model)
        {
            return model.HasStereotype(ScopeSettings.DefinitionId);
        }

        public static bool TryGetScopeSettings(this CommandModel model, out ScopeSettings stereotype)
        {
